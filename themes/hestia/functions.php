...
add_action('pre_get_posts', 'handyman_adjust_queries');

function  handyman_features(){
	...
	add_image_size('handymanLandscape',400, 260, true);
	add_image_size('handymanPortrait',480, 650, true);
...
function redirectSubsToFrontend(){
	...
	if($userNumRoles == 1 AND $userRole == 'customer'){
